...
exports.compute = function(values) {
  ...
  while (!computer.isHalted) {
    ...
    const color = panels[currentPositionCol][currentPositionRow] ? 1 : 0;

    computer.addInput(color);

    // Paint the panel
    panels[currentPositionCol][currentPositionRow] = computer.output[0];
  ...
  return Object.entries(positions).length;
};
